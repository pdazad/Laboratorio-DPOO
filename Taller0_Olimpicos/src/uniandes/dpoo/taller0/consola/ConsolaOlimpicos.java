...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pa�s que representa un atleta");
	...
	/**
	 * Ejecuta la opci�n para consultar el pais que representa un atleta
	 */
	private void ejecutarPaisDeUnAtleta()
	{
		System.out.println("\n" + "Consultar el pa�s que representa un atleta" + "\n");

		String nombreAtleta = input("Por favor ingrese el nombre del atleta a consultar");
		Pais pais = calculadora.paisAtleta(nombreAtleta);
		if (pais == null)
		{
		...
		{
			System.out.println(pais.darNombre());
