...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Calcula el pais que representa un atleta
	 * 
	 * @param nombre en String del atleta a consultar
	 * @return El objeto que contiene las propiedades del pais.
	 */
